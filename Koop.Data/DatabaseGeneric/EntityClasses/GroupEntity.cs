...
namespace Koop.Data.EntityClasses
{
			...
			
	{
		...
		/// <summary> CTor</summary>
		/// <param name="groupId">PK value for Group which data should be fetched into this Group object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public GroupEntity(System.Int32 groupId):base("GroupEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this GroupEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public GroupEntity(System.Int32 groupId, IValidator validator):base("GroupEntity")
		{
			InitClassEmpty(validator, null);
			this.GroupId = groupId;
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Jobs":
					toReturn.Add(Relations.JobEntityUsingGroupId);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoJobs()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(JobFields.GroupId, null, ComparisonOperator.Equal, this.GroupId));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<JobEntity>(EntityFactoryCache2.GetEntityFactory(typeof(JobEntityFactory))), (IEntityRelation)GetRelationsForField("Jobs")[0], (int)Koop.Data.EntityType.GroupEntity, (int)Koop.Data.EntityType.JobEntity, 0, null, null, null, null, "Jobs", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The Active property of the Entity Group<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Group"."Active"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean Active
		{
			get { return (System.Boolean)GetValue((int)GroupFieldIndex.Active, true); }
			set	{ SetValue((int)GroupFieldIndex.Active, value); }
		}

		/// <summary> The Description property of the Entity Group<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Group"."Description"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 1024<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Description
		{
			get { return (System.String)GetValue((int)GroupFieldIndex.Description, true); }
			set	{ SetValue((int)GroupFieldIndex.Description, value); }
		}

		/// <summary> The GroupId property of the Entity Group<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Group"."GroupId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 GroupId
		{
			get { return (System.Int32)GetValue((int)GroupFieldIndex.GroupId, true); }
			set	{ SetValue((int)GroupFieldIndex.GroupId, value); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<JobEntity, JobEntityFactory>("Group", true, false, ref _jobs);	}
		}
		...
		{ 
			get { return (int)Koop.Data.EntityType.GroupEntity; }
		}
