...
namespace Koop.Data.EntityClasses
{
			...
			
	{
		...
		protected RoleEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_people = (EntityCollection<PersonEntity>)info.GetValue("_people", typeof(EntityCollection<PersonEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			...
			{
				case "People":
					this.People.Add((PersonEntity)entity);
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "People":
					toReturn.Add(Relations.PersonEntityUsingRoleId);
					break;
				default:
					break;				
			}
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			...
			{
				case "People":
					this.People.Add((PersonEntity)relatedEntity);
					break;
				default:
					break;
			}
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			...
			{
				case "People":
					this.PerformRelatedEntityRemoval(this.People, relatedEntity, signalRelatedEntityManyToOne);
					break;
				default:
					break;
			}
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_people", ((_people!=null) && (_people.Count>0) && !this.MarkedForDeletion)?_people:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoPeople()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(PersonFields.RoleId, null, ComparisonOperator.Equal, this.RoleId));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._people);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._people = (EntityCollection<PersonEntity>) collectionsQueue.Dequeue();
		...
		public static IPrefetchPathElement2 PrefetchPathPeople
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<PersonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))), (IEntityRelation)GetRelationsForField("People")[0], (int)Koop.Data.EntityType.RoleEntity, (int)Koop.Data.EntityType.PersonEntity, 0, null, null, null, null, "People", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The Active property of the Entity Role<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Role"."Active"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean Active
		{
			get { return (System.Boolean)GetValue((int)RoleFieldIndex.Active, true); }
			set	{ SetValue((int)RoleFieldIndex.Active, value); }
		}
		...
		public virtual EntityCollection<PersonEntity> People
		{
			get { return GetOrCreateEntityCollection<PersonEntity, PersonEntityFactory>("Role", true, false, ref _people);	}
		}
		...
		{ 
			get { return (int)Koop.Data.EntityType.RoleEntity; }
		}
