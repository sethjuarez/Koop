...
namespace Koop.Data.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Status'.<br/><br/></summary>
	[Serializable]
	public partial class StatusEntity : CommonEntityBase
			...
			
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Jobs":
					toReturn.Add(Relations.JobEntityUsingStatusId);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoJobs()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(JobFields.StatusId, null, ComparisonOperator.Equal, this.StatusId));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<JobEntity>(EntityFactoryCache2.GetEntityFactory(typeof(JobEntityFactory))), (IEntityRelation)GetRelationsForField("Jobs")[0], (int)Koop.Data.EntityType.StatusEntity, (int)Koop.Data.EntityType.JobEntity, 0, null, null, null, null, "Jobs", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The Active property of the Entity Status<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Status"."Active"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean Active
		{
			get { return (System.Boolean)GetValue((int)StatusFieldIndex.Active, true); }
			set	{ SetValue((int)StatusFieldIndex.Active, value); }
		}

		/// <summary> The Description property of the Entity Status<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Status"."Description"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 1024<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Description
		{
			get { return (System.String)GetValue((int)StatusFieldIndex.Description, true); }
			set	{ SetValue((int)StatusFieldIndex.Description, value); }
		}

		/// <summary> The Name property of the Entity Status<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Status"."Name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)StatusFieldIndex.Name, true); }
			set	{ SetValue((int)StatusFieldIndex.Name, value); }
		}

		/// <summary> The StatusId property of the Entity Status<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<JobEntity, JobEntityFactory>("Status", true, false, ref _jobs);	}
		}
		...
		{ 
			get { return (int)Koop.Data.EntityType.StatusEntity; }
		}
