...
namespace Koop.Data.FactoryClasses
{
	...
	{
		private static readonly Dictionary<Koop.Data.EntityType, string> _entityTypeNamesCache = new Dictionary<Koop.Data.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(Koop.Data.EntityType value in Enum.GetValues(typeof(Koop.Data.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(Koop.Data.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(Koop.Data.EntityType relatedEntityType)
		{
