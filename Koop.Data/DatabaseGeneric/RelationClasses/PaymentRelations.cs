...
namespace Koop.Data.RelationClasses
{
	...
	public partial class PaymentRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between PaymentEntity and JobEntity over the m:1 relation they have, using the relation between the fields:
		...
		public virtual IEntityRelation JobEntityUsingJobId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PaymentEntity", true);
				return relation;
			}
		}
	...
	{
		internal static readonly IEntityRelation JobEntityUsingJobIdStatic = new PaymentRelations().JobEntityUsingJobId;
