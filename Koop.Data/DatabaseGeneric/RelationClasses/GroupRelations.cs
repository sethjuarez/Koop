...
namespace Koop.Data.RelationClasses
{
	...
	public partial class GroupRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.JobEntityUsingGroupId);
			return toReturn;
		}

		#region Class Property Declarations

		/// <summary>Returns a new IEntityRelation object, between GroupEntity and JobEntity over the 1:n relation they have, using the relation between the fields:
		/// Group.GroupId - Job.GroupId
		/// </summary>
		public virtual IEntityRelation JobEntityUsingGroupId
		{
			get
			{
	...
	{
		internal static readonly IEntityRelation JobEntityUsingGroupIdStatic = new GroupRelations().JobEntityUsingGroupId;
